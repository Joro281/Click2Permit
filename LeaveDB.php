...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["position"]) || empty($_POST["department"]) || empty($_POST["as_of"])) {
        ...
        // Omit 'id' from the column list in the INSERT statement
        $sqlInsert = "INSERT INTO leave1 (Lastname, Firstname, Middlename, Sex, Status, position, department, as_of) 
                      VALUES ('$lastname', '$firstname', '$middlename', '$sex', '$status', '$position', '$department', '$as_of')";
...
<head>
    ...
    <link rel="stylesheet" href="css/Leaveguide.css" />
    <style>
                ...
                <div class="overlap-3">
                    <div class="input-field-8">
                        <div class="input-with-label">
                            ...
                            <div class="input">
                                <div class="content"><input class="text-2" type="date" name="as_of" /></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="text-wrapper-3 certificate-title">Certificate of Leave Credits</div>
