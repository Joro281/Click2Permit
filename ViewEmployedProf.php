...
function getNotificationCount($lastCheckTimestamp) {
    ...
    $countSql = "SELECT COUNT(*) AS new_records FROM employed WHERE created_at > '$lastCheckTimestamp'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_id'])) {
        ...
        $deleteSql = "DELETE FROM employed WHERE ID = '$deleteId'";
        ...
        <div class="div">
            <div class="overlap">
                ...
                <div class="overlap-2">
                    ...
                    <div class="text-wrapper-3">LIST OF EMPLOYED USERS</div>
