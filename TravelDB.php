...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["destination"]) || empty($_POST["purpose"]) || empty($_POST["from_date"]) || empty($_POST["to_date"])) {
      $error = true;
      ...
      $sqlInsert = "INSERT INTO travel (Lastname, Firstname, Middlename, Sex, Status, destination, purpose, From_Date, To_Date) 
                    VALUES ('$lastname', '$firstname', '$middlename', '$sex', '$status', '$destination', '$purpose', '$from_date', '$to_date')";
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                ...
                <div class="input-field-3">
                    <div class="input-with-label">
                        ...
                        <div class="input">
                            <div class="content"><input class="text-2" type="text" name="destination" /></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="input-with-label">
        ...
        <div class="input">
            <div class="content">
                ...
                <div class="text-wrapper-3 certificate-title">Authority to Travel</div>
