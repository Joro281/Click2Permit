...
function logout() {
  ...
  function navigateToCertificate1() {
    window.location.href = "http://localhost:3000/COEDB.php"; // Replace with the desired URL
  }

  function navigateToCertificate2() {
    window.location.href = "http://localhost:3000/ServiceRecDB.php"; // Replace with the desired URL
  }

  function navigateToCertificate3() {
    window.location.href = "http://localhost:3000/LeaveDB.php"; // Replace with the desired URL
  }

  function navigateToCertificate5() {
    window.location.href = "http://localhost:3000/TravelDB.php"; // Replace with the desired URL
  }
