...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($newPassword) || empty($reenteredPassword)) {
        ...
        $updateSql = "UPDATE newemployed SET Password = ? WHERE id = ?";
...
$sql = "SELECT Firstname, Lastname, Middlename, Sex, Status, Email, Password FROM newemployed WHERE id = $user_id";
...
<head>
  ...
  function goTochat() {
    window.location.href = "http://localhost:3000/chat1.php";
  }
...
<body>
  <div class="frame">
    ...
    <div class="dropdown-content">
      ...
      <a href="#" onclick="goTochat()">Chat</a>
