...
$sql = "SELECT Lastname, Firstname, Middlename, Sex, Status FROM employed WHERE id = $userID";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["position"]) || empty($_POST["department"]) || empty($_POST["from_date"]) || empty($_POST["to_date"])) {
        ...
        $sqlInsert = "INSERT INTO closure (Lastname, Firstname, Middlename, Sex, Status, Position, Department, From_Date, To_Date) 
                      VALUES ('$lastname', '$firstname', '$middlename', '$sex', '$status', '$position', '$deapartment', '$from_date', '$to_date')";
...
<link rel="stylesheet" href="css/Closure.css" />
  <link rel="stylesheet" href="css/Closureguide.css" />
    ...
    <title>Certificate of Closure of Business/Cessation of Registration</title>
</head>
    ...
    <div class="frame">
        ...
        <div class="overlap-2">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                ...
                <div class="text-wrapper-3 certificate-title">Certificate of Closure of Business/Cessation of Registration</div>
                ...
                <div class="admin-back">
                    <div class="div-wrapper"><a href="http://localhost:3000/Software%20Design/Employed1.php">
