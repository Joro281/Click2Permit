...
function getNotificationCount($lastCheckTimestamp) {
    ...
    $countSql = "SELECT COUNT(*) AS new_records FROM coe WHERE created_at > '$lastCheckTimestamp'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_id'])) {
        ...
        $deleteSql = "DELETE FROM coe WHERE id = '$deleteId'";
        $conn->query($deleteSql);
    } elseif (isset($_POST['approve_id'])) {
        $approveId = $_POST['approve_id'];
        // Update the request status in the database to 'Approved'
        $approveSql = "UPDATE coe SET Request_Status = 'Approved' WHERE id = '$approveId'";
        ...
        $declineSql = "UPDATE coe SET Request_Status = 'Declined' WHERE id = '$declineId'";
        $conn->query($declineSql);
}
}
// Query to fetch data from the 'coe' table
$sql = "SELECT * FROM coe";
...
<body>
    ...
    $messagesSql = "SELECT * FROM coe WHERE created_at > '$lastCheckTimestamp'";
