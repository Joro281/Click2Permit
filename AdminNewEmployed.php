...
function goToUserProfile() {
  window.location.href = "http://localhost:3000/Software%20Design/UserProf1.php#";
}

function goToDocumentRequest() {
  window.location.href = "http://localhost:3000/Software%20Design/NewEmployed.php";
}
...
function logout() {
  ...
  function navigateToCertificate6() {
    window.location.href = "http://localhost:3000/Software%20Design/COEDB2.php"; // Replace with the desired URL
  }
